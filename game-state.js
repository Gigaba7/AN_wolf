...
const GameState = {
  ...
  options: {
    ...
    wolfActions: [
      ...
      { text: "ジャミング", cost: 15, displayName: "ジャミング", oldName: "編成上限8名", announcementTitle: "妨害：ジャミング(-15)", announcementSubtitle: "後援部隊との通信が妨害されました。(編成上限8名)", logMessage: "人狼妨害：ジャミング" },
      ...
      { text: "背水の陣", cost: 30, displayName: "背水の陣", oldName: "ドクター神拳使用不可", announcementTitle: "妨害：背水の陣(-30)", announcementSubtitle: "ドクターは連日の激務により本来の力が出せないようです。(ドクター神拳使用不可)", logMessage: "人狼妨害：背水の陣" },
